...
function panel_button_init(){
	...
	document.getElementById("latin_toggle").addEventListener("click", latin_toggle_pressed);
	document.getElementById("arabic_toggle").addEventListener("click", arabic_toggle_pressed);
