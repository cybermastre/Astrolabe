...
function rete(){
 ...
 // Rete Path
  ...
  gte.classList.add("ecliptic_text");
...
//------------------------------
  ...
  .on("start", function() {
    ...
    var rete_rotation_0 = document.getElementById("reteLayer").getAttribute("transform");
  ...
  .on("drag", function() {
    ...
    reteLayer.setAttribute("transform", transform_string);
  ...
  d3.select("#reteLayer").call(rete_drag);

  $("#reteLayer").on("vmouseover", function(){
    $(this).css("cursor","grab");
  });
...
function rotate_rete(){
  ...
  document.getElementById("reteLayer").setAttributeNS(null, "transform", rete_transform_string);
...
function rule(){
  ...
  var ruleGroup_inner = document.createElementNS(xmlns, "g");
  ruleGroup.appendChild(ruleGroup_inner);
  ruleGroup_inner.setAttribute("id","ruleGroup_inner");
  ...
  ruleGroup_inner.appendChild(rulepath);
  ...
  ruleGroup_inner.appendChild(fiducial_line);
  ...
  ruleGroup_inner.appendChild(rule_midline);
  ...
  ruleGroup_inner.appendChild(caparc);
  ...
  for (dec=-20;dec<70;dec+=10){
    ...
    ruleGroup_inner.appendChild(decarc);
  }
  ...
  ruleGroup_inner.appendChild(hubcircle);
  ...
  ruleGroup_inner.appendChild(hubcircle2);
  ...
  ruleGroup_inner.appendChild(bosscircle);
  ...
  ruleGroup_inner.appendChild(rivet1);
  ...
  ruleGroup_inner.appendChild(rivet2);
  ...
  //---------- rule text ----------
  var rule_textgroup = document.createElementNS(xmlns, "g");
  ruleGroup_inner.appendChild(rule_textgroup);
  rule_textgroup.setAttributeNS(null,"transform","scale(1,-1)");
  rule_textgroup.setAttributeNS(null,"font-size","2.5");
  rule_textgroup.setAttributeNS(null,"font-family","georgia");
  rule_textgroup.setAttributeNS(null, "fill", "rgb(105,85,60)");
  rule_textgroup.setAttributeNS(null, "fill", "rgb(125,105,80)");
  rule_textgroup.setAttributeNS(null, "stroke", "none");
  rule_textgroup.setAttributeNS(null, "text-anchor", "left");
  rule_textgroup.setAttributeNS(null, "id", "rule_textgroup");

  var gmer = document.createElementNS(xmlns, "g");
  rule_textgroup.appendChild(gmer);
  var tx = document.createElementNS(xmlns, "text");
  ...
  rule_textgroup.appendChild(gdiv);
  ...
  rule_textgroup.appendChild(gsep);
